...
def get_opts(args=None):
    ...
    parser.add_argument('--worker-cores',
                        default=1,
                        type=int,
    ...
    parser.add_argument('--server-memory',
                        default='1g',
                        type=str,
    ...
    parser.add_argument('--hdfs-tempdir',
                        default='/tmp',
                        type=str,
    ...
    parser.add_argument('--sge-log-dir',
                        default=None,
                        type=str,
    ...
    parser.add_argument(
        ...
        help=('Same as cached files,' +
              ...
              ' You can use this option to ship python libraries.' + ' Only valid in yarn jobs.'))
    parser.add_argument('--env',
                        action='append',
                        default=[],
                        help='Client and ApplicationMaster environment variables.')
    parser.add_argument('--yarn-app-classpath',
                        type=str,
                        help=('Explicit YARN ApplicationMaster classpath.' +
                              'Can be used to override defaults.'))
    parser.add_argument('--yarn-app-dir',
                        type=str,
    ...
    parser.add_argument(
        ...
        help=('The path to the customized gcc lib folder.' +
              'You can use this option to ship customized libstdc++' + ' library to the workers.'))
    ...
    parser.add_argument('--kube-worker-image',
