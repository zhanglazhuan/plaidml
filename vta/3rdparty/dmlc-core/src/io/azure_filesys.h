...
class AzureFileSystem : public FileSystem {
 public:
  ...
  virtual Stream* Open(const URI& path, const char* const flag, bool allow_null) { return NULL; }

  virtual SeekStream* OpenForRead(const URI& path, bool allow_null) { return NULL; }
