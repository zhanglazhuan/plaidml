...
#if DMLC_USE_FOPEN64 &&                                                                             \
    (!defined(__GNUC__) || (defined __ANDROID__) || (defined __FreeBSD__) || (defined __APPLE__) || \
...
#if (defined(__GNUC__) && !defined(__MINGW32__) && !defined(__sun) && !defined(__SVR4) && !(defined __MINGW64__) && \
     !(defined __ANDROID__)) &&                                                                                     \
    !defined(__CYGWIN__) && !defined(__EMSCRIPTEN__) && !defined(__RISCV__) && !defined(__hexagon__)
