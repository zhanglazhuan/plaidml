...
typedef void (*VTASimDPIFunc)(VTAContextHandle self, dpi8_t* wait, dpi8_t* exit);
 ...
 * \return 0 if success,
 */
typedef void (*VTAHostDPIFunc)(VTAContextHandle self, dpi8_t* req_valid, dpi8_t* req_opcode, dpi8_t* req_addr,
 ...
 */
typedef void (*VTAMemDPIFunc)(VTAContextHandle self, dpi8_t req_valid, dpi8_t req_opcode, dpi8_t req_len,
                              dpi64_t req_addr, dpi8_t wr_valid, dpi64_t wr_value, dpi8_t* rd_valid, dpi64_t* rd_value,
                              dpi8_t rd_ready);

/*! \brief The type of VTADPIInit function pointer */
typedef void (*VTADPIInitFunc)(VTAContextHandle handle, VTASimDPIFunc sim_dpi, VTAHostDPIFunc host_dpi,
 ...
 */
TVM_DLL void VTADPIInit(VTAContextHandle handle, VTASimDPIFunc sim_dpi, VTAHostDPIFunc host_dpi, VTAMemDPIFunc mem_dpi);
