...
#define VTA_LOG_INP_BUFF_SIZE 17
#define VTA_LOG_INP_WIDTH 5
#define VTA_LOG_OUT_BUFF_SIZE 17
#define VTA_LOG_OUT_WIDTH 5
#define VTA_LOG_UOP_BUFF_SIZE 15
#define VTA_LOG_WGT_BUFF_SIZE 20
#define VTA_LOG_WGT_WIDTH 5
