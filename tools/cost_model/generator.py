...
class TilePlanGenerator(object):
  ...
  def testConv2d_4_6(self):
    data = [
      ...
      _conv_inp(IN = 1, IC = 64, OC = 64, IS = [224, 224], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 128, OC = 256, IS = [56, 56], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 256, OC = 256, IS = [56, 56], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 128, OC = 128, IS = [28, 28], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 256, OC = 512, IS = [28, 28], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 512, OC = 512, IS = [28, 28], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 256, OC = 256, IS = [14, 14], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
      _conv_inp(IN = 1, IC = 512, OC = 512, IS = [14, 14], KS = [3, 3],
          strides = (1, 1), padding = 'same', data_format = 'channels_last'),
